...
const ParallelBufferedRunner = require('mocha/lib/nodejs/parallel-buffered-runner');
const {
    Queue,
    LinkedList,
    Node,
...
BinarySearchTree.prototype.toArray = function() {
    const array = [];
    if(this.left){
        this.left.toArray().map(function(e){array.push(e)})
    }
    array.push(this.value);
    if(this.right){
        this.right.toArray().map(e => array.push(e))
    }
    return array;
};
